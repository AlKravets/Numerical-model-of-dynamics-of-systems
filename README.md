...
- Двухшаговый симметризированный алгоритм.

После этого провести численный эксперимент при заданных параметрах, вывести графики решения, значения абсолютной ошибки. Для численного эксперимента даны основные параметры, а также аналитическое решение уравнения.
...
Дополнительно есть функция для создания анимации `anim_plots`. Е параметры похожи на параметры предыдущей функции, опишем те, что отличаются
